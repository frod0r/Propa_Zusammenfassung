...
\haskellinline{[]}, \haskellinline{x:xs}, \haskellinline{head[1,2,3] => 1},
\haskellinline{tail[1,2,3] => [2,3]}, \haskellinline{init xs -- Alle elemente bis auf das letzte},
\haskellinline{null[1,2,3] => False},
\haskellinline{length},\haskellinline{isIn}, \haskellinline{a ++ b},
\haskellinline{take n l -- erste n Elemente von l},
\haskellinline{drop n l  -- l ohne erste n Elemente},
\haskellinline{xs !! n -- Nte Listenelement},
%TODO: In einzellne Zellen ziehen?
